                    ...
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            ...
                            <?php
                                        ...
                                        ?>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#"><i class="fa fa-music"></i><?php echo $genres?></a>
                                        </li>
                                        <?php
                                        }
                                        ?>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                <p><i class="fa fa-map-marker"></i>34 SU Store, Istanbul, Turkey</p>
                                <p><i class="fa fa-envelope"></i>vinly@sabanciuniv.edu</p>
                                <p><i class="fa fa-phone"></i>+90 (216) 483 90 00</p>
                            </div>
                        </div>
                    </div>
